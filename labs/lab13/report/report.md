...
Создал каталог, файлы и создал объектные файлы (рис. [-@fig:5])

![Создание объектных файлов](image/1.png){#fig:5 width = 70%}
...
Просмотрел строки кода с помощью команды list (рис. [-@fig:8])

![Команда list](image/4.png){#fig:8 width = 70%}
